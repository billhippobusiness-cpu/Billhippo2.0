    ...
    return (
      <div className="max-w-7xl mx-auto space-y-6 animate-in fade-in duration-500 pb-20 font-poppins">
        ...
        <div className="bg-white rounded-[2rem] premium-shadow border border-slate-50 overflow-hidden">
          ...
          {/* Header */}
          <div className="px-5 sm:px-8 pt-8 pb-6 border-b border-slate-50" style={{ borderTop: `4px solid ${primaryColor}` }}>
          ...
          {/* Bill To / Ship To */}
          <div className="px-5 sm:px-8 py-6 grid grid-cols-1 sm:grid-cols-2 gap-4 border-b border-slate-50">
          ...
          {(vehicleNumber || transportMode) && (
            <div className="px-5 sm:px-8 py-4 bg-slate-50/50 border-b border-slate-50 flex flex-wrap gap-6">
              {vehicleNumber && (
                <div>
          ...
          <div className="px-5 sm:px-8 py-6 overflow-x-auto">
            <table className="w-full min-w-[560px] text-left border-collapse rounded-2xl overflow-hidden border border-slate-100">
              <thead>
          ...
          {showPrices && (
            <div className="px-5 sm:px-8 pb-6 flex justify-end">
          ...
          {/* Notes */}
          {notes && (
            <div className="px-5 sm:px-8 pb-6 border-t border-slate-50 pt-4">
          ...
          {/* Footer */}
          <div className="px-5 sm:px-8 py-5 border-t border-slate-100 bg-slate-50/30 text-center">
